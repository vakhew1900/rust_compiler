...
static const short yyprhs[] = {     0,
     0,     2,     5,     7,    11,    15,    19,    23,    27,    31
};

static const short yyrhs[] = {    13,
     0,    13,    14,     0,    14,     0,     3,    15,    10,     0,
    15,     6,    15,     0,    15,     5,    15,     0,    15,     7,
    15,     0,    15,     8,    15,     0,    11,    15,     9,     0,
     4,     0
};
...
static const short yyrline[] = { 0,
    33,    35,    36,    38,    40,    41,    42,    43,    44,    45
};

static const char * const yytname[] = {   "$","error","$undefined.","PRINT",
"INT","'-'","'+'","'*'","'/'","')'","';'","'('","seq","seq1","stmt","expr",""
};
#endif

static const short yyr1[] = {     0,
    12,    13,    13,    14,    15,    15,    15,    15,    15,    15
};
...
static const short yypact[] = {    -1,
    -3,    -1,-32768,-32768,    -3,     4,-32768,    10,    -3,    -3,
    -3,    -3,-32768,-32768,    13,    13,-32768,-32768,     3,    22,
-32768
};
...
static const short yytable[] = {     8,
     4,     1,    20,    15,    16,    17,    18,     5,     9,    10,
    11,    12,     7,    13,     9,    10,    11,    12,    14,    11,
    12,    21
};

static const short yycheck[] = {     5,
     4,     3,     0,     9,    10,    11,    12,    11,     5,     6,
     7,     8,     2,    10,     5,     6,     7,     8,     9,     7,
     8,     0
};
...
case 1:
#line 33 "simple.y"
{yyval.prg=prg=CreateProgram(lst_start);;
    break;}
case 2:
#line 35 "simple.y"
{yyval.lst=AppendStatementToList(yyvsp[-1].lst,yyvsp[0].stm);;
    break;}
case 3:
#line 36 "simple.y"
{yyval.lst=lst_start=CreateStList(yyvsp[0].stm);;
    break;}
case 4:
#line 38 "simple.y"
{yyval.stm=CreateStatement(yyvsp[-1].exp);;
    break;}
case 5:
#line 40 "simple.y"
{yyval.exp=CreateBinExp(1,yyvsp[-2].exp,yyvsp[0].exp);;
    break;}
case 6:
#line 41 "simple.y"
{yyval.exp=CreateBinExp(2,yyvsp[-2].exp,yyvsp[0].exp);;
    break;}
case 7:
#line 42 "simple.y"
{yyval.exp=CreateBinExp(3,yyvsp[-2].exp,yyvsp[0].exp);;
    break;}
case 8:
#line 43 "simple.y"
{yyval.exp=CreateBinExp(4,yyvsp[-2].exp,yyvsp[0].exp);;
    break;}
case 9:
#line 44 "simple.y"
...
case 10:
#line 45 "simple.y"
{yyval.exp=CreateIntExp(yyvsp[0].int_const);;
    break;}
}
